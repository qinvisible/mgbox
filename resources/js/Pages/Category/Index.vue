...
<template>
    <div class="relative ps flex  flex-col items-center justify-center" style="height: 100vh">
        <div class="container" style="height: 100vh;">
            <h2 class="text-2xl py-5">Kategori Produk Yang Tersedia</h2>
                    ...
                    <tbody>
                        <tr v-for="category in categories" :key="category.id"
                            ...
                            <td class="dark:border-neutral-500">
                                ...
                                <button class="btn btn-secondary btn-sm" @click="removeModal.open(category)">
            ...
            <Teleport to="body">
                <Dialog title="Hapus Peran" message="Apakah Anda yakin ingin menghapus kategori ini?"

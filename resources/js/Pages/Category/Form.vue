            ...
            <div class="container mx-auto">
                <perfect-scrollbar>
                    <div class="w-full p-12">
                        <h1 class="w-full text-3xl font-semibold text-left" v-if="!category.id">Tambah Kategori Untuk Produk</h1>
                        <h1 class="w-full text-3xl font-semibold text-left" v-if="category.id">Update {{ category.name }}</h1>
                        <form @submit.prevent="submit(category.id)" class="w-full">
                            ...
                            <div class="form-group flex w-full">
                                <div class="w-1/4 sm-left">
                                    <label for="desc" class="prose prose-lg">Deskripsi Kategori</label>
                                </div>
                                <div class="w-2/4 sm-left">
                            ...
                            <div class="form-group flex">
                                ...
                                <div class="w-2/4 sm-left">
                                    ...
                                    <input v-if="category.id" type="submit" value="SIMPAN" class="btn btn-md btn-primary mt-4">
                                    <input v-if="!category.id" type="submit" value="TAMBAH" class="btn btn-md btn-primary mt-4">
                                </div>
                            </div>
                        </form>
                    </div>
